...
namespace Master.Data.Migrations
{
    ...
    [Migration("20230722144435_EditNumOfSeats")]
    partial class EditNumOfSeats
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Master.Data.Models.Account.UserAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Master.Data.Models.Trips.Trip", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("AvailableNumOfSeats")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Master.Data.Models.Trips.BookedTrip", b =>
                {
                    b.HasOne("Master.Data.Models.Trips.Trip", "Trip")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("Master.Data.Models.Role.UserRole", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Master.Data.Models.Account.UserAccount", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
